...
$inventory = @(
    ...
    '- Pre-activation live claim scan: no open PR and no competing P10 implementation branch/claim was present before this governance branch was created.',
...
$evidence = @(
    ...
    '',
    'A live pre-activation scan found no open PR and no competing P10 implementation branch/claim. The canonical P10 ledger region contains exactly thirteen task rows and every row remained `PENDING`; this activation does not edit `docs/TASK_LEDGER.md`.',
    '',
