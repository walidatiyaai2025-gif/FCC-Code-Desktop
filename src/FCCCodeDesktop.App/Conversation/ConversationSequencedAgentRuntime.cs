...
/// <summary>
/// Keeps the presentation event sequence monotonic across multiple runtime executions while
/// independently verifying that every source execution remains contiguous.
/// </summary>
