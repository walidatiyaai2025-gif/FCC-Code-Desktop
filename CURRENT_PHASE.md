...
- Evidence class remains cloud/self-test for bounded, path-safe, read-only lazy file explorer mechanics and Projects-surface behavior; no new owner-only evidence, P05 exit-gate PASS, P06 phase closure, or release eligibility is implied.
